...
public:
	...
	const Vector3<T> & operator[](char i) const {
...
typedef Matrix3<INT16S>                Matrix3i;
typedef Matrix3<INT16U>               Matrix3ui;
typedef Matrix3<INT32S>                Matrix3l;
typedef Matrix3<INT32U>               Matrix3ul;
