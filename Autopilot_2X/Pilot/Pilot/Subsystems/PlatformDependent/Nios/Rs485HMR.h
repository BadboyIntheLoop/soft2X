...
#define RS485HMR_INT_ID_OFFSET		7
#define RS485HMR_INT_ID				XPAR_FABRIC_XLCONCAT_0_DOUT_INTR + RS485HMR_INT_ID_OFFSET
...
class Rs485HMR: public ODTObserver, public SerialDeviceBase
{
public:
	Rs485HMR(CPU_INT32U portID, int baudRate = 0, int outBufLines = 10);
...
private:
    ...
    static const int HMR_RS_BUFFER_SIZE = 1024;	///< Length of an output buffer

    //
    static const int  HMR_RS_DIVISOR_OFFSET 		= 0*4;
    static const int  HMR_RS_WR_FIFO_OFFSET 		= 1*4;
    static const int  HMR_RS_RESET_IRQ_OFFSET 		= 2*4;
    static const int  HMR_RS_RD_CONTROL_OFFSET 		= 0*4;
    static const int  HMR_RS_RD_FIFO_OFFSET 		= 1*4;

	/** \name Structure of an FastRS control register (0x00)
	* \{
	*/
    typedef union hmrRSControl_t{
        struct bits {
    ...
    int _irqHmrRSTag;      ///< Tag generated by a FastRS
};
